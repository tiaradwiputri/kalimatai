...
describe('Unit Testing', function(){
	describe('Injector', function(){
		...
		it('Construct all components stated in config', function(done){
			...
			expect(injector._userRepo).to.be.an.instanceof(userRepo);
			expect(injector).to.have.property('_convRepo');
			expect(injector._convRepo).to.be.an.instanceof(convRepo);
		...
		it('Resolve method construct object based on dependencies defined in config', function(done){
			...
			let conv = injector._resolve(config['components']['convRepo']);
			expect(conv).to.be.an.instanceof(convRepo);
			let user = injector._resolve(config['components']['userRepo']);
			expect(user).to.be.an.instanceof(userRepo);
